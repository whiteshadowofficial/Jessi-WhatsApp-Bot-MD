...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            GojoMdNx.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` MS.Jessica`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./GojoMedia/gojo.jpg`),"sourceUrl": "https://telegra.ph/file/57e0679dc28177770f449.jpg"}}}, { quoted: m})
        }
...
🎗️ Url : ${anu.url}`,
	    ...
	    case 'ytmp3': case 'getmusic': case 'ytaudio': {
                ...
                GojoMdNx.sendImage(m.chat, media.thumb, `🎗️ Title : ${media.title}\n🎗️ File Size : ${media.filesizeF}\n🎗️ Url : ${isUrl(text)}\n🎗️ Ext : MP3\n🎗️ Resolution : ${args[1] || '320kbps'}`, m)
		...
		let { pinterest } = require('./lib/scraper')
                ...
                GojoMdNx.sendMessage(m.chat, { image: { url: result }, caption: '🎗️ Media Url : '+result }, { quoted: m })
            }
            break
...
break
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'artinama': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🎗️ *Name :* ${anu.message.nama}\n🎗️ *Meaning :* ${anu.message.arti}\n🎗️ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🎗️ *Wedding Date :* ${anu.message.tanggal}\n🎗️ *Characteristics :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🎗️ *Born :* ${anu.message.hari_lahir}\n🎗️ *Business :* ${anu.message.usaha}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendImage(m.chat, anu.message.image, `🎗️ *Born :* ${anu.message.tgl_lahir}\n🎗️ *Tarot Symbol :* ${anu.message.simbol_tarot}\n🎗️ *Meaning :* ${anu.message.arti}\n🎗️ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
            ...
            case 'memancing': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🎗️ *Date :* ${anu.message.tgl_memancing}\n🎗️ *Results :* ${anu.message.result}\n🎗️ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🎗️ *Results :* ${anu.message.result}\n🎗️ *Notes :* ${anu.message.catatan}`, m)
            }
            break
		...
		case 'igeh': case 'instagram2x': case 'ig2': case 'igdl2': {
            ...
            case 'soundcloud': case 'scdl': {
                ...
                let msg = await GojoMdNx.sendImage(m.chat, anu.result.thumb, `🎗️ Title : ${anu.result.title}\n🎗️ Url : ${isUrl(text)[0]}`)
...
│「 Hi 👋 」
└┬❖ 「 ${pushname} 」
┌┤✑  𝗜 𝗮𝗺 𝗽𝗼𝘄𝗲𝗿𝗳𝘂𝗹𝗹 𝘄𝗵𝗮𝘁𝘀𝗮𝗽𝗽 𝘂𝘀𝗲𝗿 𝗯𝗼𝘁...🎭
││✑  🎗️🖐️!!
│└───────────────┈ ⳹
│ 「 BOT INFO 」
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
                GojoMdNx.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/57e0679dc28177770f449.jpg' }, caption: `*Hi Bro ${m.pushName}*\nDonation section is currently down🥲 , I know you are happy but me 🥲💔\n` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`GitHub : https://github.com/whiteshadowofficial/Jessi-WhatsApp-Bot-MD\n Dont Forget To Give Star\n\nYouTube : ${myweb}\nDont Forget To Watch Tutorial`)
            }
            break
case 'allmenu': {
  	anu = `
...
┃╠${prefix}juzamma
┃╠══✪「 HOROSCOPE 」☯︎
┃╠${prefix}nomorhoki (Need Word)
┃╠${prefix}artimimpi (Need Word)
┃╠${prefix}artinama (Need Word)
┃╠${prefix}ramaljodoh (Need Word)
┃╠${prefix}ramaljodohbali (Need Word)
┃╠${prefix}suamiistri (Need Word)
┃╠${prefix}ramalcinta (Need Word)
┃╠${prefix}cocoknama (Need Word)
┃╠${prefix}pasangan (Need Word)
┃╠${prefix}jadiannikah (Need Word)
┃╠${prefix}sifatusaha (Need Word)
┃╠${prefix}rezeki (Need Word)
┃╠${prefix}pekerjaan (Need Word)
┃╠${prefix}nasib (Need Word)
┃╠${prefix}penyakit (Need Word)
┃╠${prefix}tarot (Need Word)
┃╠${prefix}fengshui (Need Word)
┃╠${prefix}haribaik (Need Word)
┃╠${prefix}harisangar (Need Word)
┃╠${prefix}harisial (Need Word)
┃╠${prefix}nagahari (Need Word)
┃╠${prefix}arahrezeki (Need Word)
┃╠${prefix}peruntungan (Need Word)
┃╠${prefix}weton (Need Word)
┃╠${prefix}karakter (Need Word)
┃╠${prefix}keberuntungan (Need Word)
┃╠${prefix}memancing (Need Word)
┃╠${prefix}masasubur (Need Word)
┃╠${prefix}zodiak (Need Word)
┃╠${prefix}shio (Need Word)
┃╚═══════❤Jessi
...
And Again Me (Ms.Jessica 🎉) 🎗️ Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "YouTube📍","url": `${myweb}`}},{"urlButton": {"displayText": "Script🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
